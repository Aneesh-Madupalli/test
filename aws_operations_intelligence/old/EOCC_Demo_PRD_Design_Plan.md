---
name: EOCC Demo PRD Design
overview: EOCC phased PRD design — 57 features, Aurora schema, 4-agent architecture, 20 UC flows, technical system (3× ECS Fargate, Cortex+Pinecone, LLM Router), PRD outline. Volunteer demo to 12+ year tech lead.
todos:
...
# EOCC Phased PRD — Design Plan (Active)

**Saved references:**
- Technical system: [eocc_technical_system_07d4d768.plan.md](c:\Users\madup\.cursor\plans\eocc_technical_system_07d4d768.plan.md)
...
- Project copy: [EOCC_Demo_PRD_Design_Plan.md](test/aws_operations_intelligence/EOCC_Demo_PRD_Design_Plan.md)

**Output when executed:** [AWS_Operations_Intelligence_EOCC_PRD.md](test/aws_operations_intelligence/AWS_Operations_Intelligence_EOCC_PRD.md)  
...
**Phases 2–4:** Full step-by-step flows for UC 2, 5–20 in [EOCC_20_Use_Case_Workflows.md](test/aws_operations_intelligence/EOCC_20_Use_Case_Workflows.md).
...
**Also see consolidated plan:** [EOCC_Master_Plan.md](test/aws_operations_intelligence/EOCC_Master_Plan.md)

When you return, say **"continue from the EOCC plan"** or **"generate the PRD"**.
